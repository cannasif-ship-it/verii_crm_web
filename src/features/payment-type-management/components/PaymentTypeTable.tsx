      ...
      <div className="flex items-center justify-center py-12">
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="text-sm text-muted-foreground animate-pulse">
            {t('paymentTypeManagement.loading', 'Yükleniyor...')}
          </div>
        </div>
      </div>
    );
    ...
    <div className="w-full">
            ...
            {paymentTypes.map((paymentType: PaymentTypeDto, index: number) => (
              ...
              >
                ...
                <TableCell className="text-slate-600 dark:text-slate-400 text-sm">
                  {new Date(paymentType.createdDate).toLocaleDateString(i18n.language)}
                </TableCell>
                <TableCell className="text-slate-600 dark:text-slate-400 text-sm">
                  {paymentType.updatedDate
                    ? new Date(paymentType.updatedDate).toLocaleDateString(i18n.language)
                    : '-'}
                </TableCell>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between py-4 gap-4">
        ...
        <div className="flex gap-2">
          ...
          >
            {t('paymentTypeManagement.previous', 'Önceki')}
          </Button>
          ...
          <Button
            ...
            className="bg-white dark:bg-transparent border-slate-200 dark:border-white/10 hover:bg-slate-50 dark:hover:bg-white/5"
          >
            {t('paymentTypeManagement.next', 'Sonraki')}
          </Button>
        </div>
      </div>
