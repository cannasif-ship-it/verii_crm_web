...
export function ShippingAddressManagementPage(): ReactElement {
  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      newFilters.push(
        { column: 'Address', operator: 'contains', value: searchTerm },
        { column: 'ContactPerson', operator: 'contains', value: searchTerm },
        { column: 'CustomerName', operator: 'contains', value: searchTerm }
      );
    }
        ...
        <div className="w-full md:w-auto flex flex-col md:flex-row items-center gap-3">
          <div className="w-full md:w-auto flex items-center gap-2">
            <div className="relative group w-full md:w-[320px]">
              ...
              {/* Input Alanı */}
              <Input
                placeholder={t('shippingAddressManagement.search', 'Ara...')}
                value={searchTerm}
            ...
            <div 
              ...
              title={t('shippingAddressManagement.refresh', 'Yenile')}
            >
