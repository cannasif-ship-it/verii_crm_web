...
import { Map, Activity, Calendar, Plus, Search, RefreshCw, X } from 'lucide-react';
import {
  Card,
  CardContent,
  CardHeader,
...
export function CityManagementPage(): ReactElement {
  ...
  useEffect(() => {
    setPageTitle(t('cityManagement.menu', 'City Management'));
    return () => {
      setPageTitle(null);
    };
  }, [t, setPageTitle]);
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
          <div className="flex gap-2 w-full md:w-auto">
            <div className="relative group w-full md:w-[280px]">
              ...
              <Input
                placeholder={t('cityManagement.searchPlaceholder', 'Ara...')}
                value={searchTerm}
