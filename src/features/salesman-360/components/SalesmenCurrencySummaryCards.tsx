          ...
          <Card key={row.currency} className="rounded-xl border border-slate-200 dark:border-white/10">
            <CardContent className="pt-6">
              ...
              <div className="mt-2 space-y-1 text-sm">
                <p>
                  <span className="text-muted-foreground">{t('salesman360.currencyTotals.demandAmount')}:</span>{' '}
                  <span className="font-semibold">{formatter.format(row.demandAmount ?? 0)}</span>
                </p>
                <p>
                  <span className="text-muted-foreground">{t('salesman360.currencyTotals.quotationAmount')}:</span>{' '}
                  <span className="font-semibold">{formatter.format(row.quotationAmount ?? 0)}</span>
                </p>
                <p>
                  <span className="text-muted-foreground">{t('salesman360.currencyTotals.orderAmount')}:</span>{' '}
