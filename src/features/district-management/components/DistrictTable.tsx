...
const getColumnsConfig = (t: TFunction): ColumnDef<DistrictDto>[] => [
    ...
    { key: 'isDeleted', label: t('districtManagement.table.status', 'Durum'), type: 'status', className: 'w-[120px]' },
];
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between py-4 gap-4">
        ...
        <div className="flex gap-2">
          ...
          <div className="flex items-center px-4 text-sm font-medium text-slate-700 dark:text-slate-200">{t('common.page', 'Sayfa {{current}} / {{total}}', { current: currentPage, total: totalPages || 1 })}</div>
        ...
        <DialogContent className="bg-white dark:bg-[#130822] border border-slate-100 dark:border-white/10 text-slate-900 dark:text-white w-[90%] sm:w-full max-w-md rounded-2xl shadow-2xl overflow-hidden p-0 gap-0">
          ...
          <DialogHeader className="flex flex-col items-center gap-4 text-center pb-6 pt-10 px-6">
            ...
            <div className="space-y-2">
                ...
                {t('districtManagement.delete.confirmMessage', '{{name}} ilçesini silmek istediğinizden emin misiniz? Bu işlem geri alınamaz.', {
